...
"guidchange": "^1PROBABILE CHEAT: ^2%s ^1cambio GUID in game. ^2Kicked",
"headshot": "^4%s ^2%s HS (^4%s ^2o/o)",
"insults": "^2Gli insulti non sono permessi. ^1Ancora %s volte e verrai kikkato",
"invalidguid": "^1PROBABILE CHEAT: ^2%s ^1kikkato per GUID non regolare",
"invalidnick": "^2%s ^1kikkato per NICK non regolare",
"levassigned":"^2Assegnato livello ^4%s ^2a ^4%s.",
"lownotoriety": "^2%s ^1Affidabilita bassa o QKEY nuova: ^4%s ^2contro ^4%s ^2richiesta",
"lownotoriety2": "^2Ritorna tra ^4%s ^2giorni con la stessa QKEY",
...
"not_update": "^2Notoriety di ^4%s ^2= ^4%s",
"not_changed": "^2MIN. Notoriety per giocare sul server: ^4%s",
...
"record_daily": "^6RECORD ODIERNO di ^4%s ^6%s kills",
...
"space":"^2Slots pieni. ^4%s ^2entra in gioco o sarai kikkato.",
"spacekicked": "^2Server pieno. Spettatore ^4%s ^2kikkato.",
